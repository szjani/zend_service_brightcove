...
abstract class ZendX_Service_Brightcove_Query_Read extends ZendX_Service_Brightcove_Query_Abstract
{
    ...
    /**
     * @param string $mediaDelivery
     * @return ZendX_Service_Brightcove_Query_Read $this
     */
    public function setMediaDelivery($mediaDelivery)
    {
        $validType = array(
            ZendX_Service_Brightcove_Enums_MediaDeliveryTypeEnum::DEFA,
            ZendX_Service_Brightcove_Enums_MediaDeliveryTypeEnum::HTTP,
        );
        if (!in_array($mediaDelivery, $validType, true)) {
            throw new ZendX_Service_Brightcove_Query_ParamException('Invalid sort type: ' . $mediaDelivery);
        }

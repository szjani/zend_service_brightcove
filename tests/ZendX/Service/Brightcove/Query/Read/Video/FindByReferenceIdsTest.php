...
class ZendX_Service_Brightcove_Query_Read_Video_FindByReferenceIdsTest extends ZendX_Service_Brightcove_Query_Read_AbstractSetTest
{
    ...
    public function setUp()
    {
        ...
        $this->_query = new ZendX_Service_Brightcove_Query_Read_Video_FindByReferenceIds($this->_referenceIds);
    }

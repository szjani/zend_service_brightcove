...
class ZendX_Service_Brightcove_Set_PlaylistIdTest extends ZendX_Service_Brightcove_Set_AbstractTest
{
    ...
    {
        $this->_set = new ZendX_Service_Brightcove_Set_PlaylistId();
    }
